...
export default function ProcessCards() {
  ...
  return (
    <div className="flex md:flex-row flex-col w-full justify-between items-center md:items-start">
      <button onClick={() => useSelctedCard("card1")}>
        <ProcessCard
          title="STEP 1: 로그인 및 회원가입"
          imgUrl="/images/main/let-me-in.jpg"
      ...
      <button onClick={() => useSelctedCard("card2")}>
        <ProcessCard
          title="STEP 2: 스터디 선택 및 지원"
          imgUrl="/images/main/button_meme.jpeg"
      ...
      <button onClick={() => useSelctedCard("card3")}>
        <ProcessCard
          title="STEP 3: 면접 및 선발"
          imgUrl="/images/main/member_meme.jpg"
